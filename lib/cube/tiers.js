...
tiers[week] = {
  ...
  bin: function(d) { (d = new Date(Math.floor(d / day) * day)).setUTCDate(d.getUTCDate() - d.getUTCDay()); return d; },
  ceil: tier_ceil,
...
tiers[month] = {
  ...
  bin: function(d) { return new Date(Date.UTC(d.getUTCFullYear(), d.getUTCMonth(), 1)); },
  ceil: tier_ceil,
