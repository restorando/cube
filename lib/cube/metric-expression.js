  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_metric_primary_expression() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, reduce, event) { event.reduce = reduce; event.source = input.substring(pos0, pos); return event; })(pos0, result0[0], result0[4]);
        }
        if (result0 === null) {
          pos = pos0;
        }
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, value) { return {value: function() { return value; }, aggregate: function() { return value; }}; })(pos0, result0);
          }
          if (result0 === null) {
            pos = pos0;
          }
      ...
      function parse_event_value_expression() {
        ...
        if (result0 === null) {
          ...
          result0 = parse_type();
          if (result0 !== null) {
            result0 = (function(offset, type) { return {type: type, value: one, aggregate: one.aggregate, exists: noop, fields: noop}; })(pos0, result0);
          }
          if (result0 === null) {
            pos = pos0;
          }
      ...
      function parse_event_unary_expression() {
        ...
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, unary) { return {value: function(o) { return negate(unary.value(o)); }, aggregate: function() { return negate.aggregate(unary.value(o)) }, exists: unary.exists, fields: unary.fields}; })(pos0, result0[2]);
          }
          if (result0 === null) {
            pos = pos0;
          }
      ...
      function parse_event_primary_expression() {
        ...
        if (result0 === null) {
          ...
          result0 = parse_number();
          if (result0 !== null) {
            result0 = (function(offset, number) { return {value: function() { return number; }, aggregate: function() { return number; }, exists: noop, fields: noop}; })(pos0, result0);
          }
          if (result0 === null) {
            pos = pos0;
          }
      ...
      function computeErrorPosition() {
        ...
        add.aggregate      = function(a, b){ return {$add:      [a, b]}; }
        subtract.aggregate = function(a, b){ return {$subtract: [a, b]}; }
        multiply.aggregate = function(a, b){ return {$multiply: [a, b]}; }
        divide.aggregate   = function(a, b){ return {$divide:   [a, b]}; }
        negate.aggregate   = function(a)   { return {$multiply: [a, -1]};}
        one.aggregate      = function()    { return {$add:      [1, 0]}; }
        ...
        function compoundValue(head, tail) {
          ...
          return {
            ...
            aggregate: function() {
              var v = head.aggregate(),
                  i = -1,
                  t, op;
              while (++i < n){
                t  = tail[i],
                op = t[1].aggregate,
                v  = op(v, t[3].aggregate());
              }
              return v;
            }
          };
        ...
        function member(head, tail) {
          ...
          return {
            ...
            aggregate: function(){ return '$' + shortName; }
          };
        }
